      ...
      <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-2">
        <div>
          <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
            <img
              ...
              src="https://media.licdn.com/dms/image/v2/D5603AQFcc8_vrp3w-Q/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1714159671557?e=1748476800&v=beta&t=MrO3RCuuZM4cqs03gPaWYekTQMMIRrJjfIPmqmL_qGA"
              alt="Rishi Paul"
            />
        ...
        <div>
          <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
            <img
              className="object-cover w-full h-56 md:h-64 xl:h-80"
              src="https://res.cloudinary.com/dff97ky68/image/upload/v1720419818/WhatsApp_Image_2024-07-08_at_00.30.33_39cbe156_jour2t.jpg"
              alt="Aditi Ghosh"
            />
            <div className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100">
              <p className="mb-1 text-lg font-bold text-gray-100">
